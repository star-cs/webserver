...
extern PROTOBUF_INTERNAL_EXPORT_ns_5fprotobuf_2eproto ::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<0> scc_info_Node_ns_5fprotobuf_2eproto;
extern PROTOBUF_INTERNAL_EXPORT_ns_5fprotobuf_2eproto ::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<1> scc_info_NodeInfo_ns_5fprotobuf_2eproto;
extern PROTOBUF_INTERNAL_EXPORT_ns_5fprotobuf_2eproto ::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<1> scc_info_RegisterInfo_ns_5fprotobuf_2eproto;
namespace sylar {
namespace ns {
...
static void InitDefaultsscc_info_Node_ns_5fprotobuf_2eproto() {
...
::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<0> scc_info_Node_ns_5fprotobuf_2eproto =
    {{ATOMIC_VAR_INIT(::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase::kUninitialized), 0, 0, InitDefaultsscc_info_Node_ns_5fprotobuf_2eproto}, {}};

static void InitDefaultsscc_info_NodeInfo_ns_5fprotobuf_2eproto() {
  // GOOGLE_PROTOBUF_VERIFY_VERSION; // 注释掉版本验证，允许使用不同版本的protobuf
...
::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<1> scc_info_NodeInfo_ns_5fprotobuf_2eproto =
    {{ATOMIC_VAR_INIT(::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase::kUninitialized), 1, 0, InitDefaultsscc_info_NodeInfo_ns_5fprotobuf_2eproto}, {
      &scc_info_Node_ns_5fprotobuf_2eproto.base,}};

static void InitDefaultsscc_info_NotifyMessage_ns_5fprotobuf_2eproto() {
  // GOOGLE_PROTOBUF_VERIFY_VERSION; // 注释掉版本验证，允许使用不同版本的protobuf
...
::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<1> scc_info_NotifyMessage_ns_5fprotobuf_2eproto =
    {{ATOMIC_VAR_INIT(::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase::kUninitialized), 1, 0, InitDefaultsscc_info_NotifyMessage_ns_5fprotobuf_2eproto}, {
      &scc_info_NodeInfo_ns_5fprotobuf_2eproto.base,}};

static void InitDefaultsscc_info_QueryRequest_ns_5fprotobuf_2eproto() {
  // GOOGLE_PROTOBUF_VERIFY_VERSION; // 注释掉版本验证，允许使用不同版本的protobuf
...
::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<0> scc_info_QueryRequest_ns_5fprotobuf_2eproto =
    {{ATOMIC_VAR_INIT(::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase::kUninitialized), 0, 0, InitDefaultsscc_info_QueryRequest_ns_5fprotobuf_2eproto}, {}};

static void InitDefaultsscc_info_QueryResponse_ns_5fprotobuf_2eproto() {
  // GOOGLE_PROTOBUF_VERIFY_VERSION; // 注释掉版本验证，允许使用不同版本的protobuf
...
::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<1> scc_info_QueryResponse_ns_5fprotobuf_2eproto =
    {{ATOMIC_VAR_INIT(::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase::kUninitialized), 1, 0, InitDefaultsscc_info_QueryResponse_ns_5fprotobuf_2eproto}, {
      &scc_info_NodeInfo_ns_5fprotobuf_2eproto.base,}};

static void InitDefaultsscc_info_RegisterInfo_ns_5fprotobuf_2eproto() {
  // GOOGLE_PROTOBUF_VERIFY_VERSION; // 注释掉版本验证，允许使用不同版本的protobuf
...
::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<1> scc_info_RegisterInfo_ns_5fprotobuf_2eproto =
    {{ATOMIC_VAR_INIT(::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase::kUninitialized), 1, 0, InitDefaultsscc_info_RegisterInfo_ns_5fprotobuf_2eproto}, {
      &scc_info_Node_ns_5fprotobuf_2eproto.base,}};

static void InitDefaultsscc_info_RegisterRequest_ns_5fprotobuf_2eproto() {
  // GOOGLE_PROTOBUF_VERIFY_VERSION; // 注释掉版本验证，允许使用不同版本的protobuf
...
::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<1> scc_info_RegisterRequest_ns_5fprotobuf_2eproto =
    {{ATOMIC_VAR_INIT(::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase::kUninitialized), 1, 0, InitDefaultsscc_info_RegisterRequest_ns_5fprotobuf_2eproto}, {
      &scc_info_RegisterInfo_ns_5fprotobuf_2eproto.base,}};

static ::PROTOBUF_NAMESPACE_ID::Metadata file_level_metadata_ns_5fprotobuf_2eproto[7];
static constexpr ::PROTOBUF_NAMESPACE_ID::EnumDescriptor const** file_level_enum_descriptors_ns_5fprotobuf_2eproto = nullptr;
static constexpr ::PROTOBUF_NAMESPACE_ID::ServiceDescriptor const** file_level_service_descriptors_ns_5fprotobuf_2eproto = nullptr;

const ::PROTOBUF_NAMESPACE_ID::uint32 TableStruct_ns_5fprotobuf_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
...
const char descriptor_table_protodef_ns_5fprotobuf_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  "\n\021ns_protobuf.proto\022\010sylar.ns\"0\n\004Node\022\n\n"
  "\002ip\030\001 \001(\t\022\014\n\004port\030\002 \001(\r\022\016\n\006weight\030\003 \001(\r\""
  "J\n\014RegisterInfo\022\016\n\006domain\030\001 \001(\t\022\014\n\004cmds\030"
  "\002 \003(\r\022\034\n\004node\030\003 \001(\0132\016.sylar.ns.Node\"8\n\017R"
  "egisterRequest\022%\n\005infos\030\001 \003(\0132\026.sylar.ns"
  ".RegisterInfo\"\037\n\014QueryRequest\022\017\n\007domains"
  "\030\001 \003(\t\"F\n\010NodeInfo\022\016\n\006domain\030\001 \001(\t\022\013\n\003cm"
  "d\030\002 \001(\r\022\035\n\005nodes\030\003 \003(\0132\016.sylar.ns.Node\"2"
  "\n\rQueryResponse\022!\n\005infos\030\001 \003(\0132\022.sylar.n"
  "s.NodeInfo\"V\n\rNotifyMessage\022 \n\004dels\030\001 \003("
  "\0132\022.sylar.ns.NodeInfo\022#\n\007updates\030\002 \003(\0132\022"
  ".sylar.ns.NodeInfo"
  ;
static const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable*const descriptor_table_ns_5fprotobuf_2eproto_deps[1] = {
};
static ::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase*const descriptor_table_ns_5fprotobuf_2eproto_sccs[7] = {
  &scc_info_Node_ns_5fprotobuf_2eproto.base,
  &scc_info_NodeInfo_ns_5fprotobuf_2eproto.base,
  &scc_info_NotifyMessage_ns_5fprotobuf_2eproto.base,
  &scc_info_QueryRequest_ns_5fprotobuf_2eproto.base,
  &scc_info_QueryResponse_ns_5fprotobuf_2eproto.base,
  &scc_info_RegisterInfo_ns_5fprotobuf_2eproto.base,
  &scc_info_RegisterRequest_ns_5fprotobuf_2eproto.base,
};
static ::PROTOBUF_NAMESPACE_ID::internal::once_flag descriptor_table_ns_5fprotobuf_2eproto_once;
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_ns_5fprotobuf_2eproto = {
  false, false, descriptor_table_protodef_ns_5fprotobuf_2eproto, "ns_protobuf.proto", 458,
  &descriptor_table_ns_5fprotobuf_2eproto_once, descriptor_table_ns_5fprotobuf_2eproto_sccs, descriptor_table_ns_5fprotobuf_2eproto_deps, 7, 0,
  schemas, file_default_instances, TableStruct_ns_5fprotobuf_2eproto::offsets,
  file_level_metadata_ns_5fprotobuf_2eproto, 7, file_level_enum_descriptors_ns_5fprotobuf_2eproto, file_level_service_descriptors_ns_5fprotobuf_2eproto,
};

// Force running AddDescriptors() at dynamic initialization time.
static bool dynamic_init_dummy_ns_5fprotobuf_2eproto = (static_cast<void>(::PROTOBUF_NAMESPACE_ID::internal::AddDescriptors(&descriptor_table_ns_5fprotobuf_2eproto)), true);
namespace sylar {
namespace ns {
...
void Node::SharedCtor() {
  ::PROTOBUF_NAMESPACE_ID::internal::InitSCC(&scc_info_Node_ns_5fprotobuf_2eproto.base);
  ip_.UnsafeSetDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
...
void RegisterInfo::SharedCtor() {
  ::PROTOBUF_NAMESPACE_ID::internal::InitSCC(&scc_info_RegisterInfo_ns_5fprotobuf_2eproto.base);
  domain_.UnsafeSetDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
  node_ = nullptr;
}
...
void RegisterRequest::SharedCtor() {
  ::PROTOBUF_NAMESPACE_ID::internal::InitSCC(&scc_info_RegisterRequest_ns_5fprotobuf_2eproto.base);
}
...
void QueryRequest::SharedCtor() {
  ::PROTOBUF_NAMESPACE_ID::internal::InitSCC(&scc_info_QueryRequest_ns_5fprotobuf_2eproto.base);
}
...
void NodeInfo::SharedCtor() {
  ::PROTOBUF_NAMESPACE_ID::internal::InitSCC(&scc_info_NodeInfo_ns_5fprotobuf_2eproto.base);
  domain_.UnsafeSetDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
  cmd_ = 0u;
}
...
void QueryResponse::SharedCtor() {
  ::PROTOBUF_NAMESPACE_ID::internal::InitSCC(&scc_info_QueryResponse_ns_5fprotobuf_2eproto.base);
}
...
void NotifyMessage::SharedCtor() {
  ::PROTOBUF_NAMESPACE_ID::internal::InitSCC(&scc_info_NotifyMessage_ns_5fprotobuf_2eproto.base);
}
